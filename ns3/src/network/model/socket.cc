...
Socket::Socket (void)
  : m_manualIpTtl (false),
    ...
    m_myFifoQueueDisc(false) //added by zcw
{
...
//added by zcw 
bool
Socket::IsMyFifoQueueDisc(void) const
{
  return m_myFifoQueueDisc;
}
...
/*added by zcw*/
void
Socket::setMyFifoQueueIndex(uint8_t index)
{
  m_myFifoQueueDisc = true;
  m_myFifoQueueIndex = index;
}

uint8_t
Socket::GetMyFifoQueueIndex (void) const
{
  return m_myFifoQueueIndex;
}
/****/
...
/////////////////////////////////////////////////////
/***********queue index tag added by zew************/
/////////////////////////////////////////////////////
SocketQueueIndexTag::SocketQueueIndexTag ()
{
}

void
SocketQueueIndexTag::SetQueueIndex (uint8_t index)
{
  m_queueIndex = index;
}

uint8_t
SocketQueueIndexTag::GetQueueIndex (void) const
{
  return m_queueIndex;
}

TypeId
SocketQueueIndexTag::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::SocketQueueIndexTag")
    .SetParent<Tag> ()
    .SetGroupName("Network")
    .AddConstructor<SocketQueueIndexTag> ()
    ;
  return tid;
}

TypeId
SocketQueueIndexTag::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

uint32_t
SocketQueueIndexTag::GetSerializedSize (void) const
{
  return sizeof (uint8_t);
}

void
SocketQueueIndexTag::Serialize (TagBuffer i) const
{
  i.WriteU8 (m_queueIndex);
}

void
SocketQueueIndexTag::Deserialize (TagBuffer i)
{
  m_queueIndex = i.ReadU8();
}

void
SocketQueueIndexTag::Print (std::ostream &os) const
{
  os << "SO_QUEUEINDEX = " << m_queueIndex;
}
/////////////////////////////////////////////////////
/********end of queue index tag added by zew********/
/////////////////////////////////////////////////////
